...
const ClonePasswordPolicy = ({
  ...
  useEffect(() => {
    if (!isEmpty(passwordPolicyData)) {
      const massagedData = getPassPolicyMassagedData(passwordPolicyData);
      addPasswordPolicyValidation.resetValues({ ...massagedData });
    }
  }, [passwordPolicyLoading]);

  const getPassPolicyMassagedData = (passwordPolicyData) => {
    const tempPasswordPolicyData = { ...passwordPolicyData };
    delete tempPasswordPolicyData?.id;
    tempPasswordPolicyData.name = `copy_of_${passwordPolicyData?.name}`;
    return {
      ...tempPasswordPolicyData,
    };
  };
