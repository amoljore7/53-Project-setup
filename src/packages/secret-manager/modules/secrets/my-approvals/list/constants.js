...
export const translatedStrings = {
  ...
  manageRequestTooltip: translate('MY_APPROVALS_AND_REQUEST_MODULE.MANAGE_REQUEST_TOOLTIP'),
  approveRequestTooltip: translate('MY_APPROVALS_AND_REQUEST_MODULE.APPROVAL_REQUEST_TOOLTIP'),
  rejectRequestTooltip: translate('MY_APPROVALS_AND_REQUEST_MODULE.REJECT_REQUEST_TOOLTIP'),
  approvalPendingText: translate('MY_APPROVALS_AND_REQUEST_MODULE.APPROVAL_PENDING'),
