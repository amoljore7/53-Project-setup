...
const CloneNotificationMedium = ({
  ...
  const notificationMediumMassagedData = (data = {}) => {
    const { name, description, type, connectionParameters = {} } = data;
    return {
  ...
  useEffect(() => {
    if (!isEmpty(notificationMediumData)) {
      const mediumMassagesData = notificationMediumMassagedData(notificationMediumData);
      addNotificationMediumValidation.resetValues({ ...mediumMassagesData });
    }
  }, [notificationMediumDataStatus]);

  useEffect(() => {
    initSpinnerOverlay({
      open: isLoading(notificationMediumDataStatus) || isLoading(addNotificationMediumStatus),
...
CloneNotificationMedium.propTypes = {
  ...
  notificationMediumDataStatus: PropTypes.oneOf(typeOfStatus),
  notificationMediumData: PropTypes.object,
};

export default CloneNotificationMedium;
