...
export const getPolicyByNameRequest = (name, history, consumer, consumerEntityId, redirectPath) => ({
  type: LoadPolicyDataType.EDIT_LOAD_POLICY_JSON_REQUEST,
  payload: { name, history, consumer, consumerEntityId, redirectPath },
});
...
export const getPolicyByIdRequest = (id, history, consumer, consumerEntityId, redirectPath) => ({
  type: LoadPolicyDataType.EDIT_LOAD_POLICY_REQUEST,
  payload: { id, history, consumer, consumerEntityId, redirectPath },
});
...
export const updatePolicyRequest = (data, history, policyEntity, consumer, consumerEntityId, redirectPath) => ({
  type: EditPolicyType.EDIT_POLICY_REQUEST,
  payload: { data, history, policyEntity, consumer, consumerEntityId, redirectPath },
});
